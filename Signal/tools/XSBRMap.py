...
globalXSBRMap['kl_scan'] = od()
globalXSBRMap['kl_scan']['decay'] = {'mode':'constant','factor':1}
globalXSBRMap['kl_scan']['HH2ggtautau'] = {'mode':'constant','factor':1}
globalXSBRMap['kl_scan']['ggHHkl0kt1'] = {'mode':'constant','factor':1}
globalXSBRMap['kl_scan']['ggHHkl1kt1'] = {'mode':'constant','factor':1}
globalXSBRMap['kl_scan']['ggHHkl2p45kt1'] = {'mode':'constant','factor':1}
globalXSBRMap['kl_scan']['ggHHkl5kt1'] = {'mode':'constant','factor':1}
globalXSBRMap['kl_scan']['ggHHkl0kt1WWdilep'] = {'mode':'constant','factor':1}
globalXSBRMap['kl_scan']['ggHHkl1kt1WWdilep'] = {'mode':'constant','factor':1}
globalXSBRMap['kl_scan']['ggHHkl2p45kt1WWdilep'] = {'mode':'constant','factor':1}
globalXSBRMap['kl_scan']['ggHHkl5kt1WWdilep'] = {'mode':'constant','factor':1}
globalXSBRMap['kl_scan']['ggHHkl0kt1WWsemilep'] = {'mode':'constant','factor':1}
globalXSBRMap['kl_scan']['ggHHkl1kt1WWsemilep'] = {'mode':'constant','factor':1}
globalXSBRMap['kl_scan']['ggHHkl2p45kt1WWsemilep'] = {'mode':'constant','factor':1}
globalXSBRMap['kl_scan']['ggHHkl5kt1WWsemilep'] = {'mode':'constant','factor':1}
globalXSBRMap['kl_scan']['qqHHCV0p5C2V1kl1'] = {'mode':'constant','factor':1}
globalXSBRMap['kl_scan']['qqHHCV1p5C2V1kl1'] = {'mode':'constant','factor':1}
globalXSBRMap['kl_scan']['qqHHCV1C2V1kl1'] = {'mode':'constant','factor':1}
globalXSBRMap['kl_scan']['qqHHCV1C2V1kl0'] = {'mode':'constant','factor':1}
globalXSBRMap['kl_scan']['qqHHCV1C2V0kl1'] = {'mode':'constant','factor':1}
globalXSBRMap['kl_scan']['qqHHCV1C2V1kl2'] = {'mode':'constant','factor':1}
globalXSBRMap['kl_scan']['qqHHCV1C2V2kl1'] = {'mode':'constant','factor':1}
globalXSBRMap['kl_scan']['VH'] = {'mode':'VH'}
globalXSBRMap['kl_scan']['ggH'] = {'mode':'ggH'}
globalXSBRMap['kl_scan']['ttH'] = {'mode':'ttH'}
globalXSBRMap['kl_scan']['VBFH'] = {'mode':'qqH'}

globalXSBRMap['eft'] = od()
globalXSBRMap['eft']['decay'] = {'mode':'constant','factor':1}
globalXSBRMap['eft']['ggHHbm1'] = {'mode':'constant','factor':1}
globalXSBRMap['eft']['ggHHbm2'] = {'mode':'constant','factor':1}
globalXSBRMap['eft']['ggHHbm3'] = {'mode':'constant','factor':1}
globalXSBRMap['eft']['ggHHbm4'] = {'mode':'constant','factor':1}
globalXSBRMap['eft']['ggHHbm5'] = {'mode':'constant','factor':1}
globalXSBRMap['eft']['ggHHbm6'] = {'mode':'constant','factor':1}
globalXSBRMap['eft']['ggHHbm7'] = {'mode':'constant','factor':1}
globalXSBRMap['eft']['ggHHbm8'] = {'mode':'constant','factor':1}
globalXSBRMap['eft']['ggHHbm9'] = {'mode':'constant','factor':1}
globalXSBRMap['eft']['ggHHbm10'] = {'mode':'constant','factor':1}
globalXSBRMap['eft']['ggHHbm11'] = {'mode':'constant','factor':1}
globalXSBRMap['eft']['ggHHbm12'] = {'mode':'constant','factor':1}
