...
model_sig(){
	procs=( "ggHHbm1" "ggHHbm2" "ggHHbm3" "ggHHbm4" "ggHHbm5" "ggHHbm6" "ggHHbm7" "ggHHbm8" "ggHHbm9" "ggHHbm10" "ggHHbm11" "ggHHbm12" "VH" "ggH" "VBFH" "ttH" )
	#procs=( "ggH" "VBFH" "ttH" )
   ...
   rm -rf yields_$tag
    ...
    python makeDatacard.py --years 2016,2017,2018 --ext ${tag}"_bm"${bm_tag}  --prune --pruneThreshold 0.000000001 --doSystematics
	  python prepareDatacard_eft.py
		mv Datacard_updated.txt /home/users/fsetti/HHggTauTau/inference/datacards_run2/ggtt/EFT_cards/${tag}/datacard_bm${bm_tag}.txt
	 done
  popd
}
